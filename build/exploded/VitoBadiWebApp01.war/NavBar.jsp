        ...
        <div class="flex justify-between items-center h-16">
            ...
            <nav class="hidden md:flex space-x-6 text-gray-700 font-medium">
                ...
                <% if (logeado) { %>
                    ...
                    <% if (propietario) { %>
                        <a href="SolicitudesPropietario.jsp" class="py-4 hover:text-indigo-600">Solicitudes Propiedades</a>
                        <a href="MisAlquileresPropietario.jsp" class="py-4 hover:text-indigo-600">Alquileres</a>
                    <% } %>
                <% } %>
            </nav>
