                        ...
                        <div class="flex-grow">
                            ...
                            <div class="flex flex-col gap-3 w-full md:w-auto md:items-end">
                                <a href="DetalleHabitacion.jsp?id=<%= id%>" 
                                   class="w-full md:w-44 text-center bg-gray-100 text-gray-700 px-5 py-2.5 rounded-lg font-bold hover:bg-gray-200 transition">
                                    Ver detalle
                                </a>

                                <a href="ActualizarHabitacion.jsp?id=<%= id%>" 
                                   class="w-full md:w-44 text-center bg-indigo-600 text-white px-5 py-2.5 rounded-lg font-bold hover:bg-indigo-700 transition shadow-md">
                                    Editar
                                </a>
                            </div>
