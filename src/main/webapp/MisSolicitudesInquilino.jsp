            ...
            %>
                <article class="bg-white rounded-xl shadow-md p-4 flex flex-col md:flex-row items-center gap-6 border border-gray-100">
                    ...
                    <div class="w-32 h-32 flex-shrink-0 rounded-lg overflow-hidden bg-gray-200">
                        <img src="<%= sol.get("imagen")%>"
                             onerror="this.src='<%= request.getContextPath()%>/img/habitaciones/default.jpg'"
                    ...
                    <div class="flex flex-col gap-2 w-full md:w-auto">
                        ...
                        <% if ("pendiente".equalsIgnoreCase(sol.get("estado"))) {%>
                        <form action="MisSolicitudesInquilinoServlet" method="POST"
