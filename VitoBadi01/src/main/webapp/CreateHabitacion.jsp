...
<body class="bg-gray-100 font-sans flex flex-col min-h-screen">
    ...
    <main class="container mx-auto my-10 px-4 max-w-4xl flex-grow">
        ...
        <form action="CreateHabitacionServlet" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-xl shadow-lg space-y-8">
            ...
            <fieldset class="border-t border-gray-200 pt-4">
                ...
                <div class="grid grid-cols-1 gap-4 mt-4">
                    ...
                    <div>
                        ...
                        <textarea name="descripcion" rows="3" required class="mt-1 block w-full border border-gray-300 rounded-md p-2"></textarea>
                    </div>
                    <div class="w-1/3">
                        <label class="block text-sm font-medium text-gray-700">Precio mensual (€):</label>
                        <input type="number" name="precio" required min="0" class="mt-1 block w-full border border-gray-300 rounded-md p-2">
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset class="border-t border-gray-200 pt-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="ciudad" class="mt-1 block w-full border border-gray-300 rounded-md p-2">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Código Postal:</label>
                        <input type="text" name="cp" class="mt-1 block w-full border border-gray-300 rounded-md p-2">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Latitud:</label>
                        <input type="text" name="latitud" class="mt-1 block w-full border border-gray-300 rounded-md p-2">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Longitud:</label>
                        <input type="text" name="longitud" class="mt-1 block w-full border border-gray-300 rounded-md p-2">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Tamaño (m²):</label>
                        <input type="number" name="tamanio" required min="1" class="mt-1 block w-full border border-gray-300 rounded-md p-2">
                    </div>
                </div>
            </fieldset>
            ...
            <div class="flex justify-end gap-4">
                <a href="MisHabitacionesServlet" class="px-6 py-2 border rounded-md text-gray-600 hover:bg-gray-100">Cancelar</a>
    ...
    <%-- JavaScript SOLO para la previsualización (no lógica de guardado) --%>
    <script>
